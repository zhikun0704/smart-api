            ...
            <div class="sign-page">
                <div class="hd" style="text-align: center;">
                    <h1 style="font-size: 18pt;">
                        <a href="/smart-api/">中盈优创API管理系统</a>
                    </h1>
                </div>
                ...
                <div class="bd">
                    <form class="form" action="index/signIn" method="post" novalidate>
                        <div class="signin-title">
                            <a href="javascript:;" class="link-normal-signin">账户登录</a> <span>或</span> <a href="/smart-api/go/apply/page"
                                class="link-dingtalk-signin"> <i class="twr twr-dingtalk"></i>账户注册
                            </a>
                        </div>

                        <div class="normal-signin sigin-section">
                            <div class="signin-arrow">
                                <i class="arrow arrow-shadow-1"></i> <i class="arrow arrow-shadow-0"></i> <i class="arrow arrow-border"></i> <i
                                    class="arrow arrow-basic"></i>
                            </div>
                            <div>
                            ...
                            <div class="form-item">
                                <div class="form-field">
                                    <input type="email" name="email" id="email" placeholder="登录邮箱" data-validate="required;email"
                                        data-validate-msg="请填写你的登录邮箱" autofocus value='' />
                                </div>
                            </div>

                            <div class="form-item">
                                <div class="form-field">
                                    <input type="password" name="password" id="password" placeholder="密码" data-validate="required;length:6"
                                        data-validate-msg="请填写你的登录密码" value='' />
                                </div>
                                <div class="desc">
                                    <p class="left">
                                        <label for="cb-remember"><input type="checkbox" name="remember_me" id="cb-remember" checked
                                            value="1" /> 下次自动登录</label>
                                    </p>
                                    <p class="right">
                            ...
                            <div class="form-item form-buttons">
                                <button type="submit" id="btn-signin" class="btn btn-primary btn-submit" data-disable-with="正在登录..."
                                    data-goto="/launchpad/">登录</button>
                                <div class="desc">
