...
public class MailUtils
{
    ...
    public static final Server DEFAULT_SERVER = new Server("smtp.163.com", "pop.163.com", null);
    
    public static final Account REG_NOREPLY = new Account("mail9tong@163.com", "9tong168", "「" + Constant.getPro("sysName") + "」");
    
    public static final Server BACK_SERVER = new Server("smtp.163.com", "pop.163.com", null);
    
    public static final Account BACK_REG_NOREPLY = new Account("mail9tong@163.com", "9tong168", "「" + Constant.getPro("sysName") + "」");
     ...
     * @return
     */
    public static void asynSend(final Account account, final String to, final String subject, final String content)
    {
     ...
     * @return
     */
    public static void asynSend(final Server server, final Account account, final String to, final String subject, final String content)
    {
     ...
     * @return
     */
    public static boolean send(Account account, String to, String subject, String content)
    {
     ...
     * @return
     */
    public static boolean send(Server server, Account account, String to, String subject, String content)
    {
        ...
        try
        {
            ...
            transport.connect(server.getSmtpHost(), account.getAddress(), account.getPassword());
     ...
     * @return
     */
    public static List<Email> recieve(Server server, Account account, boolean delete)
    {
        ...
        try
        {
            ...
            store.connect(server.getPop3Host(), account.getAddress(), account.getPassword());
            // 获取默认文件夹
            ...
            for (Message msg : messages)
            {
                ...
                try
                {
                    br = new BufferedReader(new InputStreamReader(msg.getInputStream(), "GBK"));
