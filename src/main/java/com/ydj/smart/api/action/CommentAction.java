...
public class CommentAction extends BaseAction
{
    ...
    @ResponseBody
    public JSONObject docsComment(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    @ResponseBody
    public JSONObject apiComment(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        if (CommonUtils.isEmptyString(createUserId))
        {// 为了兼容修复老数据
    ...
    @ResponseBody
    public JSONObject trackComment(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
