...
public class DataAction extends BaseAction
{
    ...
    public String ajaxChangeItem(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String ajaxChangeDB(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String ajaxChangeTable(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String ajaxGetVersionList(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
