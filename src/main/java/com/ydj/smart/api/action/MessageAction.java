...
public class MessageAction extends BaseAction
{
    ...
    public String newMsg(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String addMsg(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String messageList(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        String companyId = this.getCompanyId(request, response);
    ...
    public String editeMsg(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String saveEditeMsg(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String messageDetail(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String delMsg(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        String title = new StringBuilder().append(message.getString("title")).toString();
