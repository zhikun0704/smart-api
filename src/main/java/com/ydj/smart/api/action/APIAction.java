...
public class APIAction extends BaseAction
{
    ...
    public String createAPI(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String addAPI(final HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        String href = "";
        final String title = new StringBuilder().append(belongItem).append("-->").append(belongModule).append("-->").append(name).toString();
        ...
        if (noticEmail != null && noticEmail.length > 0)
        {
            ...
            final String mailContent = new StringBuilder().append(title).append("  接口信息请访问：").append("<br>").append("<a href='" + href + "'>" + href + "</a>")
                    ...
                    public void run()
                    {
                        ...
                        try
                        {
                            if ("是".equals(wxPush))
                            {
                                ...
                                WXService.sendTemplateMessage(wxAppId, wxAppSecret, openId, itemName, pushTtitle, updateInfo, wxTemplateId, wxTemplateData,
                                        clickUrl);
                            }
                        }
                        catch (Exception e)
    ...
    public String searchApi(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String apiDetail(@PathVariable String id, String history, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String apiDetailOpenId(@PathVariable String id, @PathVariable String openId, String history, HttpServletRequest request, HttpServletResponse response)
            throws Exception
    {
    ...
    public String toEditeAPI(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String delApi(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        String title = new StringBuilder().append(api.getString("belongItem")).append("-->").append(api.getString("belongModule")).append("-->")
    ...
    public String editeAPI(final HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String apiHistory(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String ajaxChangeModule(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String ajaxParesURLAndGetResult(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String apiTest(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        String opreater = this.getUser(request, response);
        this.sysDao.saveSysLog(companyId, opreater,
                "调试[" + one.getString("belongItem") + "->" + one.getString("belongModule") + "->" + one.getString("name") + "]接口  ", href);
    ...
    public String mockTest(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        // FIXME : 暂时的假Mock ~~
        String companyId = this.getCompanyId(request, response);
        ...
        String opreater = this.getUser(request, response);
        this.sysDao.saveSysLog(companyId, opreater,
                "Mock调试[" + one.getString("belongItem") + "->" + one.getString("belongModule") + "->" + one.getString("name") + "]接口  ", href);
