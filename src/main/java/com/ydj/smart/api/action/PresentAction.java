...
public class PresentAction extends BaseAction
{
    ...
    public String thanks(HttpServletRequest request) throws Exception
    {
    ...
    public String addPresent(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        // TODO
        return "";
    }
