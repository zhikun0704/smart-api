...
public class TrackAction extends BaseAction
{
    ...
    public String createTrack(HttpServletRequest request) throws Exception
    {
    ...
    public String searchTrack(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String addTrack(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String trackDetail(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String toEditeTrack(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String delTrack(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        String title = new StringBuilder().append(track.getString("belongItem")).append("(").append(track.getString("version")).append(")").toString();
    ...
    public String editeTrack(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
