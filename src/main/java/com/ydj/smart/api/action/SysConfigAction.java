...
public class SysConfigAction extends BaseAction
{
    ...
    public String settings(HttpServletRequest request, HttpServletResponse response, String itemId) throws Exception
    {
    ...
    public String saveSettings(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        this.sysConfDao.saveSysConf4Item(companyId, itemId, tokenName, tokenDefValue, dbList, testSerList, wxAppId, wxAppSecret, wxAuthCallackUrl, wxTemplateId,
                wxTemplateData, versionList);
