...
public class UploadAction extends BaseAction
{
    ...
    @ResponseBody
    public JSONObject avatars(@RequestParam(value = "upload_file", required = true) MultipartFile file, HttpServletRequest request, HttpServletResponse response)
            throws Exception
    {
    ...
    @RequestMapping("pic")
    @ResponseBody
    public JSONObject pic(@RequestParam(value = "upload_file", required = true) MultipartFile file, HttpServletRequest request, HttpServletResponse response)
            throws Exception
    {
    ...
    @ResponseBody
    public JSONObject attachments(@RequestParam(value = "upload_file", required = true) MultipartFile file, HttpServletRequest request, HttpServletResponse response)
            throws Exception
    {
    ...
    @ResponseBody
    public JSONObject editormdPic(@RequestParam(value = "editormd-image-file", required = true) MultipartFile file, HttpServletRequest request,
