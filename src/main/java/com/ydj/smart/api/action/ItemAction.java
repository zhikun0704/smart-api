...
public class ItemAction extends BaseAction
{
    ...
    public String createItem(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    public String createModule(@PathVariable String itemId, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
