...
public class DBTableDao
{
    ...
    public List<JSONObject> getAllTables(String host, String port, String userName, String password, String dbName)
    {
        ...
        String sql = "SELECT table_comment AS 'comment',table_name AS 'tableName' FROM INFORMATION_SCHEMA.TABLES  WHERE table_schema = '" + dbName
    ...
    public List<JSONObject> getTableFileds(String host, String port, String userName, String password, String dbName, String tableName)
    {
        ...
        try
        {
            ...
            query.append("SELECT COLUMN_NAME 'column',DATA_TYPE 'type', COLUMN_COMMENT 'comment',CHARACTER_MAXIMUM_LENGTH AS 'length' ").append(" FROM COLUMNS ")
                    .append(" WHERE ").append(" table_schema = '" + dbName + "' ").append(" AND table_name = '" + tableName + "'");
