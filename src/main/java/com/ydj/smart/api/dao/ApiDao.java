...
public class ApiDao extends BaseMongoDao
{
     ...
     * @return
     */
    public Pagination<JSONObject> findApiByPage(String companyId, String belongItemId, String belongModuleId, String isDel, String versionOperater, String keyword,
            int page, int pageSize)
    {
        ...
        if (!CommonUtils.isEmptyString(isDel))
        {
            ...
            else
            {
                 ...
                 * (<= ) 小于等于 - $lte
                 */
                cond.put("versionList",
                        new BasicDBObject("$elemMatch", new BasicDBObject("version", new BasicDBObject(versionOperater, Double.parseDouble(isDel)))));
            }
