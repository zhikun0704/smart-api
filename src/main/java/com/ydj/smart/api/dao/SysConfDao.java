...
public class SysConfDao extends BaseMongoDao
{
     ...
     */
    public void saveSysConf4Item(String companyId, String itemId, String tokenName, String tokenDefValue, JSONArray dbList, JSONArray testSerList, String wxAppId,
            String wxAppSecret, String wxAuthCallackUrl, String wxTemplateId, String wxTemplateData, JSONArray versionList)
    {
        DBCollection dbc = this.getSysConf4ItemCollection();
