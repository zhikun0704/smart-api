...
public class WXService
{
     ...
     * @throws Exception
     */
    public static boolean sendTemplateMessage(String appId, String secret, String openId, String itemName, String title, String updateInfo, String templateId,
            String templateData, String clickUrl) throws Exception
    {
